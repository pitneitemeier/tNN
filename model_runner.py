...
if __name__=='__main__':
    ...
    env = tNN.Environment(condition_list=[schrodinger, norm, init_cond], h_param_range=h_param_range, batch_size=50, epoch_len=2e5, 
        val_condition_list=[val_cond], val_h_params=val_h_params, val_t_arr=val_t_arr, t_range=(0,3), num_workers=48)

    ckpt = 'TFI8x_DeepConv1.ckpt'
    model = models.multConvDeep.load_from_checkpoint(ckpt, num_h_params=1, learning_rate=1e-3)
    ...
    trainer.save_checkpoint('TFI8x_DeepConv_slurm.ckpt')
