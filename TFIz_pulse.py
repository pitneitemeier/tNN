...
if __name__=='__main__':
    ...
    schrodinger = cond.schrodinger_eq_time_dep(h_list=h_list, lattice_sites=lattice_sites, name='TFI', 
        h_func=pulse, sampler=train_sampler, t_range=(0,3), epoch_len=epoch_len)
    ...
    test_cond = cond.Time_dep_Test(magn_op, corr_list, h_list, lattice_sites, ED_magn, ED_corr, val_alpha, val_h_params, val_sampler, 
        name=f'TFI {init_polarization}', plot_folder=f'results/TFI{lattice_sites}{init_polarization}2/',
    ...
    trainer = pl.Trainer(fast_dev_run=False, gpus=[0,1], max_epochs=6,
