...
if __name__=='__main__':
    ...
    folder = f'ED_data/TFI_XX2_{lattice_sites}/'
    append = '.csv'
    ...
    train_sampler = sampler.RandomSampler(lattice_sites, 8)
    ...
    model = models.ParametrizedFeedForward(lattice_sites, num_h_params=1, learning_rate=1e-3, psi_init=psi_init_x_forward,
        act_fun=nn.GELU, kernel_size=2, num_conv_layers=3, num_conv_features=24,
