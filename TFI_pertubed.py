...
if __name__=='__main__':
    ...
    model = models.TestModel(lattice_sites, num_h_params=1, learning_rate=1e-3, psi_init=psi_init_pert,
        ...
        tNN_hidden=128, tNN_num_hidden=3, mult_size=1024, psi_hidden=80, psi_num_hidden=3, step_size=5, gamma=0.1, init_decay=1)
    ...
    neptune_logger = NeptuneLogger(
            ...
            name=f'TFI{lattice_sites}{init_polarization}',
            close_after_fit=False
        )
    neptune_logger.log_hyperparams(h_param_dict)

    trainer = pl.Trainer(fast_dev_run=False, gpus=-1, max_epochs=7,
    ...
    trainer.save_checkpoint(f'TFI{lattice_sites}{init_polarization}_FF_slurm_1.ckpt')
